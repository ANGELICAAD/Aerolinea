...
CREATE TABLE `ciudaddestino` (
  ...
  KEY `fk_idCiudadDestinoOrigen_idx` (`idCiudadOrigen`),
  CONSTRAINT `fk_idCiudadDestinoOrigen` FOREIGN KEY (`idCiudadOrigen`) REFERENCES `ciudadorigen` (`idCiudadOrigen`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `ciudaddestino` VALUES (3,'Armenia',0,1),(4,'San Andrés',0,1),(5,'Bogotá',0,3);
...
-- Dump completed on 2021-12-12 15:42:31
